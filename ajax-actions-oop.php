...
class PathaoAPI {
  ...
  public function __construct($wpdb) {
    ...
    $this->client_id = $data->api_client_id;
    $this->client_secret = $data->api_client_secret;
    $this->username = $data->user_name;
    $this->password = $data->user_password;
    $this->grant_type = $data->user_password;
  ...
  private function getAccessToken() {
      ...
      $url_for_token = "https://api-hermes.pathao.com/aladdin/api/v1/issue-token";
      ...
      if (!is_wp_error($response)) {
          ...
          return $response_for_token->access_token;
      }
  ...
  public function getCities() {
      ...
      $url_for_get_cities = "https://api-hermes.pathao.com/aladdin/api/v1/countries/1/city-list";
  ...
  public function getStores() { 
      ...
      $url_for_get_stores = "https://api-hermes.pathao.com/aladdin/api/v1/stores";
  ...
  public function getZonesByCity($city_id) {
      ...
      $url_for_get_zones = "https://api-hermes.pathao.com/aladdin/api/v1/cities/" . $city_id . "/zone-list";
...
$pathao_api = new PathaoAPI($client_id, $client_secret, $username, $password, $grant_type);

// add_action('wp_ajax_save_shipping_cities', array($pathao_api, 'getCities'));
// add_action('wp_ajax_nopriv_save_shipping_cities', array($pathao_api, 'getCities'));
...
function save_shipping_cities() {
  ...
  $pathao_api->getCities ;

}

// add_action('wp_ajax_save_stores', array($pathao_api, 'getStores'));
// add_action('wp_ajax_nopriv_save_stores', array($pathao_api, 'getStores'));

add_action( 'wp_ajax_save_stores', 'save_stores' );
add_action( 'wp_ajax_nopriv_save_stores', 'save_stores' );
function save_stores() {
  
  $pathao_api->getStores ;

}



// add_action('wp_ajax_get_zones_by_city', array($pathao_api, 'getZonesByCity'));
// add_action('wp_ajax_nopriv_get_zones_by_city', array($pathao_api, 'getZonesByCity'));
